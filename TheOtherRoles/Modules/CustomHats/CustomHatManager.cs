...
public static class CustomHatManager
{
    ...
    internal static string RepositoryUrl
    {
        get
        {
            ...
            return Helpers.isChinese() ? $"https://ghproxy.amongusclub.cn/https://raw.githubusercontent.com/{owner}/{repository}/master" : $"https://raw.githubusercontent.com/{owner}/{repository}/master";
        }
    }
