...
namespace TheOtherRoles.Objects {
    class Bloodytrail {
        ...
        public static List<Sprite> getBloodySprites() {
            ...
            sprites.Add(Helpers.loadSpriteFromAssetBundle("Blood1.png", 700));
            sprites.Add(Helpers.loadSpriteFromAssetBundle("Blood2.png", 500));
            sprites.Add(Helpers.loadSpriteFromAssetBundle("Blood3.png", 300));
            return sprites;
        }
