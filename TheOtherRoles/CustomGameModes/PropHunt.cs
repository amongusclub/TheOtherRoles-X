    ...
    class PropHunt {
        ...
        public static void poolablePlayerUpdate() {
            if (poolablesBackground == null) {
                ...
                if (poolablesBackgroundSprite == null) poolablesBackgroundSprite = Helpers.loadSpriteFromAssetBundle("poolablesBackground.jpg", 200f);
            }
        ...
        public static Sprite getSpeedboostButtonSprite() {
            ...
            speedboostButtonSprite = Helpers.loadSpriteFromAssetBundle("SpeedboostButton.png", 115f);
...
#if PC
            var resourceBundle = assembly.GetManifestResourceStream("TheOtherRoles.Resources.IntroAnimation.intro_Win");
#else
            var resourceBundle = assembly.GetManifestResourceStream("TheOtherRoles.Resources.IntroAnimation.intro_Android");
#endif
