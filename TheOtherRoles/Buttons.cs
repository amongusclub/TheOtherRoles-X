    ...
    public static void createButtonsPostfix(HudManager __instance)
    {
        ...
        garlicButton = new CustomButton(
            () =>
            {
                ...
                var writer =
                    AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.PlaceGarlic, SendOption.Reliable);
        ...
        portalmakerPlacePortalButton = new CustomButton(
            () =>
            {
                ...
                var writer =
                    AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.PlacePortal, SendOption.Reliable);
                writer.WriteBytesAndSize(buff);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
        ...
        trapperButton = new CustomButton(
            () =>
            {
                ...
                var writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.SetTrap, SendOption.Reliable);
                writer.WriteBytesAndSize(buff);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
        ...
        bomberButton = new CustomButton(
            () =>
            {
                    ...
                    MurderAttemptResult.BlankKill)
                {
                    ...
                    var writer =
                        AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.PlaceBomb, SendOption.Reliable);
                    writer.WriteBytesAndSize(buff);
                    AmongUsClient.Instance.FinishRpcImmediately(writer);
        ...
        yoyoButton = new CustomButton(
            () =>
            {
                ...
                else
                {
                    ...
                    if (SubmergedCompatibility.IsSubmerged) SubmergedCompatibility.ChangeFloor(exit.y > -7);
                    var writer =
                        AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.YoyoBlink, SendOption.Reliable);
                    writer.Write(byte.MaxValue);
                    writer.WriteBytesAndSize(buff);
                    AmongUsClient.Instance.FinishRpcImmediately(writer);
